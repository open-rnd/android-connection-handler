...
public class ObjectListenerHandler<T> {
    ...
    /**
     * Gets size of registered weak listeners.
     *
     * @return Size of registered weak listeners.
     */
    ...
    /**
     * Gets size of registered strong listeners.
     *
     * @return Size of registered strong listeners.
     */
    public synchronized  int getSizStrongListener(){
